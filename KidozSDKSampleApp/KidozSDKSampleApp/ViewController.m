...
- (IBAction)loadBanner:(id)sender {
    if([[KidozSDK instance]isBannerInitialized]){
        ...
        [self logOut:@"Banner Not Initialized" withUITextView:logText withTimestamp:[self getTimestamp]];
...
- (IBAction)showBanner:(id)sender {
    ...
    if([[KidozSDK instance]isBannerReady]){
        ...
        [self logOut:@"Banner Not Ready" withUITextView:logText withTimestamp:[self getTimestamp]];
    }
...
- (IBAction)loadInterstitial:(id)sender {
    ...
    if([[KidozSDK instance]isInterstitialInitialized]){
        ...
        [self logOut:@"Interstitial Not Initialized" withUITextView:logText withTimestamp:[self getTimestamp]];
...
- (IBAction)showInterstitial:(id)sender {
    ...
    if([[KidozSDK instance]isInterstitialReady]){
        ...
        [self logOut:@"Interstitial Not Ready" withUITextView:logText withTimestamp:[self getTimestamp]];
    }
}
...
- (IBAction)loadRewarded:(id)sender {
    ...
    if([[KidozSDK instance]isRewardedInitialized]){
        ...
        [self logOut:@"Rewarded not Initialized" withUITextView:logText withTimestamp:[self getTimestamp]];
    }
}
...
- (IBAction)showRewarded:(id)sender {
    ...
    if([[KidozSDK instance]isRewardedReady]){
        ...
        [self logOut:@"Rewarded not Ready" withUITextView:logText withTimestamp:[self getTimestamp]];
    }
}
